...
```sh
# amd64
docker pull ghcr.io/brhelwig/freecad-container:latest-amd64
docker run --rm ghcr.io/brhelwig/freecad-container:latest-amd64 freecadcmd --version

# arm64
docker pull ghcr.io/brhelwig/freecad-container:latest-arm64
docker run --rm ghcr.io/brhelwig/freecad-container:latest-arm64 freecadcmd --version
```
